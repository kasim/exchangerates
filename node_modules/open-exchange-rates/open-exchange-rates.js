...
(function() {
	...
	/*
	oxr.timeseries = function(start_date, end_date, base, symbols, callback) {
	    var url = oxr.api_url + 'time-series.json' + '?app_id=' + oxr.app_id + '&start=' + start_date + '&end=' + end_date + '&base' + base + '&symbols=' + symbols + 'prettyprint=0';
	    console.log(url);
